...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VideoSettings_t, stringdata) + ofs \
...
const QMetaObject VideoSettings::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_VideoSettings.data,
      qt_meta_data_VideoSettings,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VideoSettings::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoSettings.stringdata))
        return static_cast<void*>(const_cast< VideoSettings*>(this));
