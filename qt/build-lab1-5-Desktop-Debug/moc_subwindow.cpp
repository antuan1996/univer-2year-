...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_subwindow_t, stringdata) + ofs \
...
const QMetaObject subwindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_subwindow.data,
      qt_meta_data_subwindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *subwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_subwindow.stringdata))
